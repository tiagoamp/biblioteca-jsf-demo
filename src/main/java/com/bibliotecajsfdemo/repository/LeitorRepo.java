...
public class LeitorRepo {
    ...
    public LeitorRepo() {
        leitores.add(new Leitor(11122233344L, "John Snow", LocalDate.of(2000, Month.NOVEMBER, 3), "john@got.com"));
        leitores.add(new Leitor(22233344455L, "Tyrion Lannister", LocalDate.of(1990, Month.DECEMBER, 13), "tyrion@got.com"));
        leitores.add(new Leitor(33344455566L, "Sansa Stark", LocalDate.of(2002, Month.JULY, 2), "sansa@got.com"));
        leitores.add(new Leitor(44455566677L, "Sandor Clegane", LocalDate.of(1980, Month.NOVEMBER, 3), "theround@got.com"));
    }
